...
namespace Practica.TiendasAPI.Controllers
{
    ...
    public class ProductoController : Controller
    {
        ...
        public async Task<ActionResult<IEnumerable<ProductoDto>>> GetProducts(int shopId, int pageSize = 10, int pageNumber = 1)
        {
            ...
            var (products, metadata) = await _shopRepository.GetProductosAsync(shopId, pageSize, pageNumber);
