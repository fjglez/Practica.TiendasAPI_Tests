...
namespace Practica.TiendasAPI.Services
{
    ...
    {   
        ...
        public async Task<(IEnumerable<Producto>,PaginationMetadata)> GetProductosAsync(int shopId, int pageSize, int pageNumber)
        {
        ...
        public async Task<(IEnumerable<Tienda>,PaginationMetadata)> GetTiendasAsync(string? filterBy, string? query, int pageSize, int pageNumber)
        {
